...
interface PageContentProps {
  today: Date
  awards: IAward[]
  // currentPeriod: IPeriod // DEPRECATED
...
const PageContent = ({ today, awards = [], currentMonthPeriod, initialCriticalErrors, initialPeriods, userData, initialIncidents }: PageContentProps) => {
